...
entity HW7Q4Mux_tb is
end entity HW7Q4Mux_tb;

-----------------------------------------------------------

architecture testbench of HW7Q4Mux_tb is
	...
	constant test : test_array := (
		(X"AA", X"AB", X"AC", X"AD", "00", X"2A"),
		(X"BA", X"BB", X"BC", X"BD", "01", X"17"),
		(X"CA", X"CB", X"CC", X"CD", "10", X"98"),
		(X"DA", X"DB", X"DC", X"DD", "11", X"74")
		);	 		
